...
/*
 ...
 in Brouser consol if we write
            'cat' || "dog" //both are not bool so it return frist value
            'cat'
             true || "cat" // one bool and true so it will retun first value
             true
            'cat' || true
            'cat'
            "cat" || true
            ...
            'cat'
             ...
             false || "cat" // if the first value is boolean and that is false so it return second value
            'cat'
